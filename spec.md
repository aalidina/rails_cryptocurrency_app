...
- [x] Include at least one many-to-many relationship (x has_many y through z, y has_many x through z; e.g. Coin has_many users through transactions, user has has_many coins through transaction)
...
- [x] Include nested resource "new" form (URL e.g. recipes/1/ingredients/new) user/1/wallet/new and user/1/transaction/new
